  ...
  return (
    <>
      <button
        ...
        className={`group flex min-h-[84px] flex-col items-center justify-center rounded-xl border text-center transition-all ${
          browsing
            ? "border-primary/30 bg-primary/10 shadow-[0_0_0_1px_rgba(109,91,247,0.18)]"
            : "border-dashed border-border bg-card hover:border-primary/20 hover:bg-muted/30"
        }`}
      >
        <span className="flex h-9 w-9 items-center justify-center rounded-full border border-border bg-muted/40 transition-colors group-hover:border-primary/20 group-hover:bg-primary/10">
          <Plus className="h-4 w-4 text-primary" />
        </span>
        <span className="mt-2 text-[11px] font-medium text-foreground">Add Repo</span>
      </button>

      {browsing && (
        <div className="col-span-3 overflow-hidden rounded-xl border border-border bg-background">
